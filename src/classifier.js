  ...
  hypertensionClassification(string) {
    ...
    if (jsonArray == "Invalid Data") {
      ...
      if (lastItem.SysBP >= 180 && lastItem.DiaBP >= 120) {
        ...
        if ((lastItem.SysBP < 180 && lastItem.SysBP >= 160) || (lastItem.DiaBP < 110 && lastItem.DiaBP >= 100)) {
          classification = "Stage 2";
        } else {
          if ((lastItem.SysBP < 160 && lastItem.SysBP >= 140) || (lastItem.DiaBP < 100 && lastItem.DiaBP >= 90)) {
